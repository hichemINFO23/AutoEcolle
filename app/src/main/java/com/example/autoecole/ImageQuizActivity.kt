...
class ImageQuizActivity : AppCompatActivity() {
    ...
    private val questions = listOf(
        ...
        Question(R.drawable.cedezlepassage150m, "قف على 150 م", listOf("لافتة إرشاد قبل محول في طريق سريعة", "حظيرة سيارات", "غابة سهلة الاحتراق")) ,
        ...
        Question(R.drawable.foret, "غابة سهلة الاحتراق", listOf("ممنوع دخول الدراجات النارية", "مسلك اجباري للحافلات", "اشعال الاضواء")),
        ...
        Question(R.drawable.routeglissantetemp, "خطر مؤقت طريق زلق", listOf("ممنوع مرور الراجلين", "لافتة إرشاد قبل محول في طريق سريعة ", "اولوية السير للاتجاه المؤدي")),
    ...
    private fun showNextQuestion() {
        ...
        questionTextView.text = question.correctAnswer
    ...
    private fun checkAnswer(selectedAnswer: String) {
        ...
        if (currentQuestionIndex < questions.size) {
            ...
            val resultText = "You got $numCorrectAnswers out of ${questions.size} questions correct."
